...
const CALC_ITEM_MODIFIERS: Record<string, CalcItemModifier> = {
  ...
  "Black Belt": { summary: "Fighting damage x1.2" },
  "Black Glasses": { summary: "Dark damage x1.2" },
  "Charti Berry": { summary: "Rock damage x0.5" },
  "Charcoal": { summary: "Fire damage x1.2" },
  ...
  "Dragon Fang": { summary: "Dragon damage x1.2" },
  "Expert Belt": { summary: "SE damage x1.2" },
  "Fairy Feather": { summary: "Fairy damage x1.2" },
  "Haban Berry": { summary: "Dragon damage x0.5" },
  "Hard Stone": { summary: "Rock damage x1.2" },
  "Iron Ball": {
  ...
  "Magnet": { summary: "Electric damage x1.2" },
  "Metal Coat": { summary: "Steel damage x1.2" },
  "Miracle Seed": { summary: "Grass damage x1.2" },
  "Mystic Water": { summary: "Water damage x1.2" },
  "Never-melt Ice": { summary: "Ice damage x1.2" },
  "Occa Berry": { summary: "Fire damage x0.5" },
  "Passho Berry": { summary: "Water damage x0.5" },
  "Payapa Berry": { summary: "Psychic damage x0.5" },
  "Poison Barb": { summary: "Poison damage x1.2" },
  "Rindo Berry": { summary: "Grass damage x0.5" },
  "Roseli Berry": { summary: "Fairy damage x0.5" },
  "Sharp Beak": { summary: "Flying damage x1.2" },
  "Shuca Berry": { summary: "Ground damage x0.5" },
  "Silk Scarf": { summary: "Normal damage x1.2" },
  "Silver Powder": { summary: "Bug damage x1.2" },
  "Soft Sand": { summary: "Ground damage x1.2" },
  "Spell Tag": { summary: "Ghost damage x1.2" },
  "Tanga Berry": { summary: "Bug damage x0.5" },
  "Twisted Spoon": { summary: "Psychic damage x1.2" },
