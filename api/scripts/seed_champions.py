...
HELD_ITEMS: list[tuple[str, str, str, int | None]] = [
    ...
    # --- Competitive staple held items ---
    ("Assault Vest", "assault-vest", "held", 1000),
    ("Bright Powder", "bright-powder", "held", None),
    ("Choice Band", "choice-band", "held", 1000),
    ("Choice Scarf", "choice-scarf", "held", None),
    ("Choice Specs", "choice-specs", "held", 1000),
    ("Clear Amulet", "clear-amulet", "held", 700),
    ("Covert Cloak", "covert-cloak", "held", 700),
    ("Eject Button", "eject-button", "held", 1000),
    ("Eject Pack", "eject-pack", "held", 1000),
    ("Expert Belt", "expert-belt", "held", 700),
    ("Focus Band", "focus-band", "held", None),
    ("Focus Sash", "focus-sash", "held", None),
    ("Grassy Seed", "grassy-seed", "held", 700),
    ("Iron Ball", "iron-ball", "held", 700),
    ("King's Rock", "kings-rock", "held", None),
    ("Leftovers", "leftovers", "held", None),
    ("Life Orb", "life-orb", "held", 1000),
    ("Light Ball", "light-ball", "held", 1000),
    ("Light Clay", "light-clay", "held", 700),
    ("Loaded Dice", "loaded-dice", "held", 700),
    ("Mental Herb", "mental-herb", "held", 1000),
    ("Protective Pads", "protective-pads", "held", 700),
    ("Quick Claw", "quick-claw", "held", None),
    ("Rocky Helmet", "rocky-helmet", "held", 1000),
    ("Room Service", "room-service", "held", 700),
    ("Safety Goggles", "safety-goggles", "held", 700),
    ("Scope Lens", "scope-lens", "held", 1000),
    ("Shell Bell", "shell-bell", "held", 700),
    ("Terrain Extender", "terrain-extender", "held", 700),
    ("Throat Spray", "throat-spray", "held", 700),
    ("Weakness Policy", "weakness-policy", "held", 1000),
    ("White Herb", "white-herb", "held", None),
    ("Wide Lens", "wide-lens", "held", 700),
]
